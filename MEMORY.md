...
- Próxima task: TASK-005 (`ImageProcessor` — resize/crop/deteção de bordas/correção de perspetiva/deskew/contraste/blur/brilho + métricas `sharpness_score`/`brightness_score`/`perspective_score`).
